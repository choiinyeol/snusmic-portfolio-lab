...
|---|---:|---:|---:|---:|---:|---:|
| **Prophet** (SMIC-Constrained) | 18,468.79M | 1억 | **+18,368.79M** | **267.75%** | 39.4% | 488 |
| **Weak Prophet** (6M max-Sharpe) | 3,002.99M | 1억 | +2,902.99M | 150.44% | 27.4% | 1,134 |
| **All-Weather** (벤치마크) | 206.67M | 1억 | +106.67M | 28.46% | 9.5% | 181 |
...
#### Prophet (총 1종목, 평가금 합 18,468.79M KRW)

| symbol | 회사 | 수량 | 평단 | 종가 | 평가금(M) | 평가손익 |
|---|---|---:|---:|---:|---:|---:|
| 375500.KS | DL이앤씨 | 180,183 | 59,335 | 102,500 | 18,468.79 | +73.0% |

> 마지막 리밸런스(2026-04-01)에서 SMIC 리포트 중 다음 6개월 안에 목표가에 도달할 종목이 DL이앤씨 단 1건이라 전액 집중. 진입가 59,335 → 종가 102,500 → 미실현 +73%. 시뮬 끝까지 holding 후 다음 리밸런스에서 자동 회전.
...
#### All-Weather (총 4종목, 평가금 합 206.3M KRW)

| symbol | 회사 | 수량 | 평단 | 종가 | 평가금(M) | 평가손익 |
|---|---|---:|---:|---:|---:|---:|
| 069500.KS | KOSPI 200 ETF | 595 | 39,007 | 92,665 | 55.1 | +138.0% |
| QQQ | NASDAQ-100 ETF | 56 | 588,166 | 936,608 | 52.5 | +59.0% |
| SPY | S&P 500 ETF | 50 | 704,573 | 1,028,506 | 51.4 | +46.0% |
| GLD | Gold ETF | 73 | 269,222 | 647,221 | 47.2 | +140.0% |
...
- **올웨더 vs 충신**: 단순 4분할 ETF 적립(MDD 9.5%)이 SMIC 1/N 적립(MDD 15.2%)을 IRR·MDD 양쪽에서 모두 제칩니다 — 추종자가 사라는 대로 사면 분산만으로는 부족하다는 증거.
- **All-Weather의 MDD가 9.5%로 낮은 이유**: 4자산이 서로 상관관계 0에 가깝고 (금 vs 미국 주식 vs 한국 주식), 매월 비중을 강제로 25/25/25/25 로 되돌리는 mean-reversion 효과 덕분. 단, 리밸런스는 **모든 4개 거래소가 모두 영업하는 날**에만 집행됨 — 한쪽이 휴장이면 다음 영업일로 이연 (예: Thanksgiving 같이 한국은 열리지만 미국이 닫힌 날에 KOSPI 100% 쏠림이 생기지 않도록).

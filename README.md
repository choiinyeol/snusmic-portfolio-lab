...
|---|---:|---:|---:|---:|---:|---:|
| **Weak Prophet** (6M 룩어헤드) | 30억 0,299M | 1억 | **+29억 0,299M** | **150.00%** | 27.4% | 1,134 |
| **Prophet** (예언자, 상한선) | 20억 9,297M | 1억 | +19억 9,297M | 131.31% | 27.7% | 2,509 |
| **All-Weather** (벤치마크) | 2억 1,783M | 1억 | +1억 1,783M | 30.94% | 9.96% | 211 |
| **SMIC Follower v2** (손절 추가) | 1억 8,120M | 1억 | +0억 8,120M | 23.00% | 21.6% | 1,904 |
| **SMIC Follower** (1/N 충신) | 1억 3,901M | 1억 | +0억 3,901M | 12.86% | 14.7% | 3,946 |

> 주의: 위 수치는 raw OHLC (auto_adjust=False) 기준이라 배당 재투자가 빠져 있어 페르소나 모두 약간 보수적. 또한 일부 페르소나의 순위가 변동될 수 있는 이유는 Weak Prophet과 v2가 raw 가격에서 더 큰 기여 종목을 잡았기 때문 (예: NE / TS / 에이피알). 순위는 가격 데이터 갱신 주기에 따라 미세하게 흔들립니다.

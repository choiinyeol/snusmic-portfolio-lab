...
| **All-Weather** (벤치마크) | 211.88M | 1억 | +111.88M | 29.44% | 9.5% | 250 |
...
#### All-Weather (총 4종목, 평가금 합 211.5M KRW)

| symbol | 회사 | 수량 | 평단 | 종가 | 평가금(M) | 평가손익 |
|---|---|---:|---:|---:|---:|---:|
| 069500.KS | KOSPI 200 ETF | 610 | 39,012 | 92,665 | 56.5 | +138.0% |
| QQQ | NASDAQ-100 ETF | 58 | 599,518 | 936,608 | 54.3 | +56.0% |
| SPY | S&P 500 ETF | 50 | 697,932 | 1,028,506 | 51.4 | +47.0% |
| GLD | Gold ETF | 76 | 280,371 | 647,221 | 49.2 | +131.0% |
...
- **올웨더 vs 충신 v1**: 단순 4분할 ETF 적립(IRR 29.4% / MDD 9.5%)이 SMIC 1/N 적립(IRR 21.3% / MDD 15.2%)을 IRR·MDD 양쪽 모두에서 이깁니다 — 추종자가 사라는 대로 사면 분산만으로는 글로벌 ETF DCA를 못 따라잡는다는 증거.
...
- **현금 배당**: 각 ETF의 ex-date 마다 보유 주수 × 주당배당금을 KRW 환산해 cash 로 입금 (`data/warehouse/benchmark_dividends.csv` 캐시). 15% 원천징수 차감 후 다음 per-asset 리밸런스에서 자동 재투자. GLD 는 무배당이라 0건, QQQ/SPY 는 분기, 069500.KS 는 월별 분배.

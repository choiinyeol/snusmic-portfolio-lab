...
import { getLatestReportTargetsBySymbol, getPersonaLabel, getPositionEpisodes, getReportSymbolById, getReportTargetsById, getSummaryRows, getTrades } from '@/lib/artifacts';
...
export default function TradesPage() {
  ...
  return (
    <>
      ...
      <TradesTable trades={trades} episodes={episodes} personaLabels={personaLabels} capitalByPersona={capitalByPersona} reportSymbolsById={reportSymbolsById} targetsBySymbol={targetsBySymbol} targetsByReportId={targetsByReportId} />
    </>
  );
}
